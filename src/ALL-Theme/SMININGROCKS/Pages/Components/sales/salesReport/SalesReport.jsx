...
import {
  ...
  checkDates,
  checkMonth,
} from "../../../../Utils/globalFunctions/GlobalFunction";
...
const SalesReport = () => {
  ...
  const handleSearch = ( eve, searchValue, fromDates, toDates, grossWtFrom, grossWtTo ) => { 
    ...
    data?.forEach((e, i) => {
      ...
      // const formattedDate = moment(dateString, 'DD MMM YYYY').format('DD-MM-YYYY');
        ...
        <Box sx={{ paddingRight: "15px", paddingBottom: "20px" }}>
          <LocalizationProvider dateAdapter={AdapterDayjs}>
            <DatePicker
              ...
              //   } else {
              //     if (
              //       (newValue["$y"] <= 2099 && newValue["$y"] >= 1900) || newValue["$y"] < 1000 || isNaN(newValue["$y"])
              //     ) {
              //       setFromDate(newValue);
              //     } else {
              //       Swal.fire({
