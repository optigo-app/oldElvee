...
export default function FAQ() {
    // http://astore.orail.co.in/astore/html/faq.txt
    const[faqTamplate,setFaqTamplate]=useState()

    useEffect(()=>{
        // fetch("https://bstore.optigoapps.com/astore/html/faq.txt").then(async(res)=>
        fetch("https://cdnfs.optigoapps.com/content-global3/astoreCNARMLXHPFKS6TIY1/astore/html/faq.html").then(async(res)=>
        {
            let _faqTemplate = await res.text()
            console.log("res",_faqTemplate)
            setFaqTamplate(_faqTemplate)
        })
    })

    return (
    // <div dangerouslySetInnerHTML={{ __html: faqTamplate }} />
    <div style={{
        ...
        <div>
            ...
            <div className='smiling-FaqMain'>
                <div className='smiling-FaqSubMain'>
                    <p className='smiling-FaqMainTitle' style={{ paddingTop: '110px' }}>KayraCreation World</p>
                    <p className='smiling-FaqMainSubTitle'>How Are KayraCreation diamonds made?</p>
                    <p className='smiling-FaqMainDesc'>Lab-grown diamonds are diamonds with the same crystal structure, chemical composition, and physical properties as the mined rocks: carbon atoms arranged in a cubic crystal structure. They are grown in labs, with advanced technological processes that stimulate the same conditions under which mined diamonds develop when they form in the mantle, beneath the Earthâ€™s crust
                        <br />
                        <br />
                        Here at KayraCreation we proudly offer only laboratory-grown, socially and environmentally conscious diamonds in our fine jewelry.
                        <br />
                        <br />
                    ...
                    <p className='smiling-FaqMainSubTitle'>Cs of KayraCreation </p>
                    <p className='smiling-FaqMainDesc'>Here in KayraCreation, we believe in building a chain of smile with our Customers, Colleagues, Community, because we Care. </p>
                    ...
                    <p className='smiling-FaqMainDesc'>Yes, all KayraCreation diamonds are laser-inscribed with our logo. Also, if you are purchasing a loose diamond, that's one carat up, the stones will be inscribed with an IGI certification number.</p>

                    <p className='smiling-FaqMainSubTitle'>Iâ€™d like to purchase loose diamonds in large quantity, how can I do so?</p>
                    <p className='smiling-FaqMainDesc'>If you are interested in working with us, please contact order@KayraCreation.com and we will assist your requests accordingly.</p>

                    <p className='smiling-FaqMainSubTitle'>Can I choose to donate with each purchase?</p>
                    <p className='smiling-FaqMainDesc'>Yes, we have set up a channel for the charitable distribution of funds so that 10% of the proceeds from your purchase is contributed to KayraCreation Foundation, Inc. (the â€œFoundationâ€). The Foundation will be responsible for dispersing the funds to the specific charities that you choose when making a purchase from the website. While 10% of your purchase is ultimately contributed to the charitable organizations, tax deductions are not available to each individual customer since the customerâ€™s donations are not directly contributed.</p>
                    ...
                    <p className='smiling-FaqMainSubTitle'>I havenâ€™t received my package. How can I track my order?</p>
                    <p className='smiling-FaqMainDesc'>You can track your package with DHL or FedEx. If you see any issue with your delivery, please contact our support team at order@XYZ.com and we will get on the case.</p>
                    ...
                    <p className='smiling-FaqMainDesc'>At the time of your return request, we will send you a prepaid FedEx return label. Please include the copy of your original dispatch document inside the box, and make sure that all your personal details are filled on the dispatch. Make sure to receive a proof of postage from the FedEx office when you ship back your item. We will not be liable for any items that might be lost in transit or donâ€™t arrive if you have chosen a different shipping method. All returns must be sent back as a single shipment. Please make sure to insure your jewelry for the value that was paid. You are responsible for the insurance fees of the return shipment.
                        <br />
                        <br />
                        We will be more than happy to assist you. Simply send us an email to order@XYZ.com and we will walk you through all the details.</p>
                    ...
                    <p className='smiling-FaqMainDesc'>Be rest assured with your KayraCreation jewelry! We will provide you with Lifetime Warranty guarantee with any jewelry purchased from KayraCreation. If you believe your item has any manufacturing defect, you can ship it to us with your proof of purchase for us to inspect. If we determine the jewelry damage is valid, we will repair the item.</p>
                    ...
                    <p className='smiling-FaqMainDesc'>Our repair policy excludes wear and tear, loss of diamonds, product loss or item being stolen and any repairs or work not done by KayraCreation will void this warranty. For a repair request, we will first need to receive a proof of purchase shipped together with the jewelry. If the repair request is aligned with our policy, we will proceed with the request. If it is not, we will notify you if the repair service is available and what it will cost. The repaired items will be delivered back to your given shipping address in one to two weeksâ€™ time. We offer complimentary shipping back to the customers for all warrantied repairs.</p>

                    <p className='smiling-FaqMainSubTitle'>Special Order Request</p>
                    <p className='smiling-FaqMainSubTitle'>Iâ€™d like to engrave my name on my jewelry, can I do so?</p>
                    <p className='smiling-FaqMainDesc'>Yes! But we can only engrave your initials on your jewelry.  If you have purchased our KayraCreation jewelry and wish to engrave your initials on it, we are happy to help you do so. Email us at order@XYZ.com and with proof of purchase for us to confirm and proceed with your request.</p>

                    <p className='smiling-FaqMainSubTitle'>In what Karat gold is done KayraCreation jewelry?</p>
                    <p className='smiling-FaqMainDesc'>10K gold. If you wish to place any of our favorite order in a different metal purity (14K or 18K), email us at order@XYZ.com and we will look into your request.
                        <br />
                        <br />
                        All special orders are not refundable or returnable. They will take around 2 weeksâ€™ time to deliver from the date of purchase.</p>

                    <p className='smiling-FaqMainTitle'>Account Support</p>

                    <p className='smiling-FaqMainSubTitle'>How do I create an account?</p>
                    <p className='smiling-FaqMainDesc'>To create an account simply click the Sign In button and Register Now to fill in your details. Please create an account password which is unique and kept secure. You must notify KayraCreation immediately of any unauthorized use of your account.
                        <br />
                        <br />
                        With a KayraCreation account you will be able to enjoy the following benefits:</p>

                    <p className='smiling-FaqMainSubTitle'>I need help to login to  My Account:</p>
                    <p className='smiling-FaqMainDesc'>If you are experiencing any issues to login into your account, please donâ€™t hesitate to contact our Customer Support team at order@XYZ.com and we will assist you with any questions.</p>
                    ...
                    <p  style={{
                        color: '#7d7f85',
                        fontWeight: 700
                    }}>If you have any more questions for us, feel free to contact us at order@XYZ.com. Shop with a Smile!</p>
                </div>
                <Footer />
            </div>
        </div>
