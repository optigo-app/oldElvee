        ...
        <div className='exploreMain'>
          <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center', gap: '10px', margin: '60px 0px 90px 0px' }}>
              ...
              <p className='smilingExpolerBoxDesc' style={{ width: '420px', fontFamily: "TT Commons, sans-serif", fontSize: '13px', textAlign: 'center' }}>The founders of KayraCreation have a mission to spread smiles through supporting different charity organizations.</p>
